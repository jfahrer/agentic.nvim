...
.PHONY: luals selene selene-file format-check format format-file check test validate install-hooks benchmark-tool-call-folding
...
benchmark-tool-call-folding:
	$(NVIM) --headless -u tests/init.lua -c "lua require('agentic.tool_call_folding_benchmark').run_cli()"
